...
export default function EnhancedTable() {
  ...
  const update = (e) =>{
    var objIndex = Funders.findIndex((obj => obj.id == e.id));
    Funders[objIndex] = e
  }
  ...
  return (<>
    {/* {authenticated &&} */}
    {/* {!detail ? */}
    <BaseCard titleColor={"secondary"} title="GESTION DES BAILLEURS">
    ...
    {/* :
    <DetailFunder clientsCount = {200 } numbersCount = {200 } Funder = {selected} />
    } */}
  </>);
}
