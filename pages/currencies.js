...
export default function EnhancedTable() {
  ...
  React.useEffect(() => {
      ...
      /* apiService.getCurrentMonth().then(
        ...
        //if(cMonth){
          apiService.getCurrencies( //pageNumber, pageSize, getBy
            ).then(
              res => {
  ...
  const push = (e) =>{
    //Currencies.push(e)
    apiService.getCurrencies( //pageNumber, pageSize, getBy, currentMonth.monthId
      ).then(
        res => {
          console.log(res.data);
          setCurrencies(res.data);
  ...
  const remove = () =>{
    if(selected !== null){
      apiService.deleteCurrency(selected.id).then(
        res => {
          console.log(res);
