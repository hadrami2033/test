...
import PaymentStatusTypeForm from "./add_paymentstatustype";
...
export default function EnhancedTable() {
  ...
  const remove = () =>{
    if(selected !== null){
      axios.delete(`/paymentstatustype/${selected.id}`).then(
        res => {
          console.log(res);
  ...
  return (<>
    {/* {authenticated &&} */}
    {/* {!detail ? */}
    <BaseCard titleColor={"secondary"} title="STATUTS DE REMBOURSEMENT">
