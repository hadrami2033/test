...
const headCells = [
  {
    id: 'nom_prenom_raison_sociale',
    numeric: false,
    disablePadding: false,
    label: 'Nom',
  },
  {
    id: 'personne_juridique',
    numeric: false,
    disablePadding: false,
    label: 'Type',
  },
...
export default function EnhancedTable({origin}) {
  ...
  const remove = () =>{
    fetch(`${origin}/api/proprietaire?id=${selected.id}`, { method: 'DELETE' })
    .then((response) => {
  ...
  return (<>
    {/* {authenticated &&} */}
    {/* {!detail ? */}
    <BaseCard titleColor={"secondary"} title="Propriétaires">
                  ...
                  .map((row, index) => {
                    return (
                      ...
                      >
                        ...
                        <TableCell></TableCell>
                        <TableCell align="left">{row.nom_prenom_raison_sociale}</TableCell>
                        <TableCell align="left">{row.personne_juridique}</TableCell>
                        <TableCell align="left">{row.nom_commerciale}</TableCell>
                        <TableCell align="left">{row.nni}</TableCell>
                        <TableCell align="left">{row.telephone}</TableCell>
                        <TableCell align="left">{row.statut_telephone}</TableCell>
